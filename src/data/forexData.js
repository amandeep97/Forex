...
export const STRUCTURE_TIMEFRAMES = [
  { value: '1m',  label: '1M'  }, { value: '2m',  label: '2M'  },
  { value: '5m',  label: '5M'  },
...
export const forexPairs = [
  ...
  // Cross-majors (complete the currency matrix)
  item('EUR/CHF', 'Forex', 'Minors', 0.93412, 0.93448,  0.11, 0.93720, 0.93180, 12400, 'NEUTRAL',     51.4,  0.0006),
  item('EUR/CAD', 'Forex', 'Minors', 1.47521, 1.47565,  0.24, 1.47920, 1.47120, 13800, 'BUY',         58.2,  0.0021),
  item('EUR/NZD', 'Forex', 'Minors', 1.78412, 1.78468,  0.31, 1.78920, 1.77980, 9200,  'BUY',         60.1,  0.0031),
  item('GBP/CAD', 'Forex', 'Minors', 1.72510, 1.72562,  0.28, 1.72980, 1.72110, 10400, 'BUY',         59.4,  0.0028),
  item('GBP/AUD', 'Forex', 'Minors', 1.91520, 1.91584,  0.42, 1.92120, 1.90980, 9800,  'STRONG_BUY',  66.8,  0.0042),
  item('GBP/NZD', 'Forex', 'Minors', 2.08510, 2.08590,  0.38, 2.09210, 2.07840, 7600,  'BUY',         62.1,  0.0038),
  item('AUD/CHF', 'Forex', 'Minors', 0.58512, 0.58548, -0.22, 0.58720, 0.58310, 8900,  'SELL',        42.3, -0.0009),
  item('AUD/CAD', 'Forex', 'Minors', 0.90521, 0.90565,  0.14, 0.90820, 0.90210, 10200, 'NEUTRAL',     52.8,  0.0011),
  item('AUD/NZD', 'Forex', 'Minors', 1.08512, 1.08556, -0.18, 1.08820, 1.08210, 8400,  'NEUTRAL',     48.6, -0.0008),
  item('NZD/JPY', 'Forex', 'Minors', 88.5210, 88.5540,  0.48, 88.8900, 88.1200, 11200, 'BUY',         59.2,  0.2100),
  item('NZD/CHF', 'Forex', 'Minors', 0.54012, 0.54048, -0.24, 0.54220, 0.53810, 6800,  'SELL',        41.8, -0.0008),
  item('NZD/CAD', 'Forex', 'Minors', 0.83510, 0.83554,  0.12, 0.83820, 0.83210, 7200,  'NEUTRAL',     51.1,  0.0009),
  item('CAD/CHF', 'Forex', 'Minors', 0.64512, 0.64548, -0.16, 0.64720, 0.64310, 8100,  'NEUTRAL',     49.4, -0.0007),
  item('CHF/JPY', 'Forex', 'Minors', 168.521, 168.565,  0.36, 168.920, 168.120, 12600, 'BUY',         57.6,  0.3100),
  // Exotics
